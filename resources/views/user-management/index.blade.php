                ...
                <div>
                    ...
                    <div class="mb-8">
                        <div class="flex flex-row items-center justify-center">
                            <a href="{{ route('user-management') }}" class="flex justify-center items-center px-4 py-2 mr-2 bg-gray-800 rounded-md font-medium text-white hover:bg-tertiary-hover focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 transition">
                                Refresh
                    ...
                    <div class="bg-gray-800 border-t border-grey-300 p-4 text-white font-medium rounded-t-lg">
                        Admin
                    </div>
                    ...
                    @endif
                    @endforeach
                    <div class="bg-gray-800 border-t border-grey-300 p-4 text-white font-medium">
                        {{ __('User') }}
                    </div>
                    @foreach($users as $user)
                    @if(!$user->is_admin)
